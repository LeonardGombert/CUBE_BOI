Shader "Custom/Outline/OutlineBlur"
{
	Properties{
	   ...
	   _NormalMult("Normal Outline Multiplier", Range(0,12)) = 1
	   _NormalBias("Normal Outline Bias", Range(1,12)) = 1
	   _DepthMult("Depth Outline Multiplier", Range(0,12)) = 1
	   _DepthBias("Depth Outline Bias", Range(1,12)) = 1
	   _StepValue("StepValue", Range(0,1)) = 1
